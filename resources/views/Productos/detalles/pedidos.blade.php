        ...
        <div class="bg-white rounded-lg p-7 dark:bg-slate-800">
            ...
            @if (!$pedidos->count())
                <div class="text-center mt-12  py-20 rounded-md dark:bg-slate-500">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No hay productos vendidos</h3>
                    <p class="mt-1 text-sm text-gray-500  dark:text-white">Aun no has vendido ningun producto </p>
                </div>
            @endif
