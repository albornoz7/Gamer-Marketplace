...
<div class="w-3/5 mx-auto">
    <form action="{{route('actualizar.producto',$productos)}}" method="POST"  enctype="multipart/form-data">
    @method('PUT')       
    @csrf
    ...
    <div class="w-full md:w-[48.5%]">
        <div style="animation: scale-up-center 1s cubic-bezier(0.4, 0, 0.2, 1) both; ">
            <button type="submit" class="dark:bg-gray-400 w-full bg-slate-900 duration-200">
                <div class="bg-blue-400 dark:bg-slate-900 dark:border-blue-400 active:translate-x-0 active:translate-y-0 flex items-center border-slate-900 border-2 duration-200 px-4 py-2 -translate-x-1 -translate-y-1 hover:-translate-x-1.5 hover:-translate-y-1.5 w-full">
