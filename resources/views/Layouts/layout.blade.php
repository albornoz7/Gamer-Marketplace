        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <div class="flex items-center space-x-3 lg:pr-16 ">
                    ...
                    <h2 class="font-normal text-2xl leading-6 text-gray-800">Gamers MarketPlace</h2>
                </div>
            ...
            <!-- boton Carrito-->
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                        <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <li>
                                <a href="{{ route('categoria', ['categoria' => 'todos']) }}" class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-gray-700 md:p-0 md:dark:text-blue-500" aria-current="page">PRODUCTOS</a>
                            </li>
                        </ul>
                </div>
        </nav>
